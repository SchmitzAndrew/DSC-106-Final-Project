<script>
  ...
  <section class="box" data-index={1}>
    <div class="text-content">
      ...
      <p>To start Data Scientists first make an assumption that being that the true, underlying density has a 
        certain form. A common assumption used is that the true distribution is Gaussian, also known as 
        ...
        deviation controls the width of the distribution. Because we do not know the true density of the distribution we 
  ...
  <section class="box" data-index={2}>
    <div class="text-content">
      ...
      <p>Below is data sampled from the NBA showing the average number of rebounds center and points guards gotten
        ...
        yours with the best possible fit using our interactive features.</p>
  ...
  <section class="box" data-index={5}>
    <div class="text-content">
      <p> As you experimented with different parameter inputs you may have observed some inputs gave better
        results than others. Is there a way to quantify this without guessing and checking? Luckily,
         ...
         is to assume the data are all sampled independently. Next let's say that P(xi, Mu, Sigma) is
          ...
          tells us the likelihood of seeing x1, x2,..., xn, the entire data set, at the same time. We can think of this as a function of Mu and Sigma. 
...
<section class="box" data-index={11}>
  <div class="text-content">
    <p> As you can see we did not use an advanced algorithm to create our predictions.
  ...
  <section class="box" data-index={12}>
    <div class="text-content">
      <p> Some of you who are more familiar with statistics and math may wonder why would someone 
        ...
        we will never fully understand how to quantify all the random interactions that happens that sum up
